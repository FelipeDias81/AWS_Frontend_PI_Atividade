...
export class ProfessoresService {
  private apiUrl = 'https://api.pitrabalho.duckdns.org/teacher/';  // Nova URL da API
  private cursosUrl = 'https://api.pitrabalho.duckdns.org/courses'; // Caso precise acessar cursos também
