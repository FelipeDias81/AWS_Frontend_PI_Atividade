...
export class GradeFixaService {
  private apiUrl = 'https://api.pitrabalho.duckdns.org/reservation/';
  private teachersUrl = 'https://api.pitrabalho.duckdns.org/teacher/';
  private subjectsUrl = 'https://api.pitrabalho.duckdns.org/subject/';
  private timesUrl = 'https://api.pitrabalho.duckdns.org/time/';
  private roomsUrl = 'https://api.pitrabalho.duckdns.org/rooms/';
  private coursesUrl = 'https://api.pitrabalho.duckdns.org/course/';
