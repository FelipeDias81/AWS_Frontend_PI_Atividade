...
export class CcursoService {
  private apiUrl = 'https://api.pitrabalho.duckdns.org/course/';  // URL principal para cursos
  private disciplinesUrl = 'https://api.pitrabalho.duckdns.org/subject/';  // URL para buscar as disciplinas
